			...
			<div class="flex h-full max-h-screen flex-col gap-2">
				<nav class="grid items-start p-2 px-4 font-medium">
					{#snippet navItem(
						...
						<a
							class="text-muted-foreground flex items-center gap-3 rounded-lg px-3 py-2 transition-all"
							{href}
					...
					<button
						class="text-muted-foreground mt-4 flex items-center gap-3 rounded-lg bg-transparent px-3 py-2 transition-all"
